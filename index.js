...
bot.login(require('./config.js').token).then(() => { console.log(`[!] — Logged in as ${bot.user.tag} (${bot.user.id})`); }).catch(() => { console.log('\x1b[31m[!] — Please configure a valid bot token\x1b[0m'); });
...
bot.functions = require('./Utils/Functions/etirage.js')
